...
class TestNetwork(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_batch = np.load('tests/softmax_grad_check/test_batch.npy', allow_pickle=True)
        self.test_label = np.load('tests/softmax_grad_check/test_label.npy', allow_pickle=True)
    ...
    def test_two_layer_net(self):
        ...
        w1_grad_expected = np.load('tests/twolayer_grad_check/w1.npy', allow_pickle=True)
        b1_grad_expected = np.load('tests/twolayer_grad_check/b1.npy', allow_pickle=True)
        w2_grad_expected = np.load('tests/twolayer_grad_check/w2.npy', allow_pickle=True)
        b2_grad_expected = np.load('tests/twolayer_grad_check/b2.npy', allow_pickle=True)
